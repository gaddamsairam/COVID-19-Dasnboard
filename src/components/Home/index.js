...
import StatesOverReview from '../StatesOverReview'
    ...
    return (
      <>
        <div testid="countryWideConfirmedCases" className="stats-block-column">
          ...
          <img
            src="https://res.cloudinary.com/ddzm2v7i3/image/upload/v1642770587/covid-19%20project/check-mark_1df_zojxpe.png"
            className="stats-icon"
            alt="country wide confirmed cases pic"
          />
          <p className="stats-number red">{confirmedCases}</p>
        </div>

        <div testid="countryWideActiveCases" className="stats-block-column">
          <p className="stats-title blue">Active</p>
          <img
            src="https://res.cloudinary.com/ddzm2v7i3/image/upload/v1642770595/covid-19%20project/protection_1pro_shgpsn.png"
            className="stats-icon"
            alt="country wide active cases pic"
          />
          <p className="stats-number blue">{activeCases}</p>
        </div>

        <div testid="countryWideRecoveredCases" className="stats-block-column">
          <p className="stats-title green">Recovered</p>
          <img
            src="https://res.cloudinary.com/ddzm2v7i3/image/upload/v1642770613/covid-19%20project/recovered_1rec_d6s3k3.png"
            className="stats-icon"
            alt="country wide recovered cases pic"
          />
          <p className="stats-number green">{recoveredCases}</p>
        </div>

        <div testid="countryWideDeceasedCases" className="stats-block-column ">
          <p className="stats-title gray">Deceased</p>
          <img
            src="https://res.cloudinary.com/ddzm2v7i3/image/upload/v1642770621/covid-19%20project/breathing_1dec_e2xwu9.png"
            className="stats-icon"
            alt="country wide deceased cases pic"
          />
          <p className="stats-number gray">{deceasedCases}</p>
        </div>
      </>
    )
  }
      ...
      <div className="all-states-table" testid="stateWiseCovidDataTable">
        ...
        <div className="state-wise-data-container">
          <ul className="other-tables">
            {statesInfo.map(each => (
              <StatesOverReview key={each.stateCode} data={each} />
            ))}
          </ul>
        </div>
      </div>
